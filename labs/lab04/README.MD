...
Выполняем на R23, R24, R25, R26 [минимальные настройки](https://github.com/sneim/otus-network-engineer/tree/main/labs/lab04/configs), указываем разные зоны, проверяем.
